 ...
 @include('javascript.counterdiv')
  ...
  <div class="row">
     ...
     <br>
        ...
        <li  class="active"><a href="/analysis/pie"> <i class="fa fa-pie-chart faa-pulse animated" aria-hidden="true"></i> Pie Chart</a></li>
        <li><a href="/analysis/doughnut"><i class="fa fa-pie-chart faa-pulse animated" aria-hidden="true"></i> Doughnut Chart</a></li>
      </ul>
      <a class="btn btn-success" href="/filtergraph/pie/courses"><i class="fa fa-filter faa-float animated" aria-hidden="true"></i> Filter</a>
     </div>

      @include('javascript.pie.view_pie')
...
@section('script')
  <script  src="/js/Chart.bundle.min.js"></script>
   ...
   @include('javascript.pie.script_pie')
