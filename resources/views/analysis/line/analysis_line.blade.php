...
@section('content')
    ...
    <div class="row">
      ...
      <br>
        ...
        <li  class="active"><a href="/analysis/line"><i class="fa fa-line-chart faa-pulse animated" aria-hidden="true"></i> Line Chart</a></li>
      ...
      <a class="btn btn-success" href="/filtergraph/line/courses"><i class="fa fa-filter faa-float animated" aria-hidden="true"></i> Filter</a>
     </div>


      @include('javascript.line.view_line')
  ...
  <script  src="/js/Chart.bundle.min.js"></script>
   ...
   @include('javascript.line.script_line')
