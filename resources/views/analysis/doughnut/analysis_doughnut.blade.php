  ...
  <div class="row">
   ...
   <br>
      ...
      <li><a href="/analysis/bar"><i class="fa fa-bar-chart faa-pulse animated" aria-hidden="true"></i> Bar Chart</a></li>
        ...
        <li class="active"><a href="/analysis/doughnut"><i class="fa fa-pie-chart faa-pulse animated" aria-hidden="true"></i> Doughnut Chart</a></li>
    </ul>
    <a class="btn btn-success" href="/filtergraph/doughnut/courses"><i class="fa fa-filter faa-float animated" aria-hidden="true"></i> Filter</a>
   </div>

        @include('javascript.doughnut.view_doughnut')
  </div>
  <br><br><br>
...
@stop
  ...
  <script  src="/js/Chart.bundle.min.js"></script>
   ...
   @include('javascript.doughnut.script_doughnut')
