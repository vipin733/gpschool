...
<div class="row">
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
         <button class="btn btn-primary btn-block">
            Search deleted registration fee transactions({{ $asession['name'] }})
         </button>
        </div>
    ...
    <div class="col-md-12">
      <div class="panel panel-default">
        <div class="panel-heading">
         <button class="btn btn-primary btn-block">
            All deleted registration fee transaction({{ $asession['name'] }})
         </button>
        </div>
        <div class="panel-body">
     	    <div class="table-responsive text-center">
            <table class=" table table-bordered  table-hover" id="delete_registration_fees">
              <thead>
                <tr>
...
<script type="text/javascript">
   var oTable = $('#delete_registration_fees').DataTable({
     processing: true,
     serverSide: true,
     dom: 'Bfrtip',
          buttons: [
        ...
        serverSide: true,
        ajax: {
            url: '/acadmic/delete/transactions/registration/ajax',
            data: function (d) {
