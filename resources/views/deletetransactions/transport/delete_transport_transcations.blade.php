...
<div class="row">
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
         <button class="btn btn-primary btn-block">
            Search deleted trasnport fee transactions({{ $asession['name'] }})
         </button>
        </div>
    ...
    <div class="col-md-12">
      <div class="panel panel-default">
        <div class="panel-heading">
         <button class="btn btn-primary btn-block">
            All deleted trasnport fee transaction({{ $asession['name'] }})
         </button>
        </div>
        <div class="panel-body">
     	    <div class="table-responsive text-center">
            <table class=" table table-bordered  table-hover" id="delete_transport_fees">
              <thead>
                <tr>
...
<script type="text/javascript">
   var oTable = $('#delete_transport_fees').DataTable({
     processing: true,
     serverSide: true,
     dom: 'Bfrtip',
          buttons: [
        ...
        serverSide: true,
        ajax: {
            url: '/acadmic/delete/transactions/transport/ajax',
            data: function (d) {
