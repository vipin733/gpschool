  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Update tution fee</h4>
      </div>
      <div class="modal-body">
          
        <form method="POST" action="{{ route('tutions.update',$fee->id) }}" data-parsley-validate ="">
        {{ csrf_field() }} {{ method_field('PATCH') }}

           <div class="form-group">
              <label for="tution_fee">Fee (Monthely) :</label>
              <input type="text" class="form-control" id="tution_fee" name="tution_fee" value="{{ old('tution_fee', $fee->tution_fee) }}" placeholder="Fee" required="" data-parsley-type="number">
            </div>
