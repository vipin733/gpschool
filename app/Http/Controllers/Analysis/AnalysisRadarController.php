...
class AnalysisRadarController extends Controller
{
    ...
    public function yearradar(Request $request)
    {
    	...
    	return view('testing.radar.radaryear')
    	       ->with('student',json_encode($student,JSON_NUMERIC_CHECK))
              ->with('year',json_encode($year,JSON_NUMERIC_CHECK));

    }

    public function coursesradar(Request $request)
    {
    	$query = $request->year;
    ...
    public function combinedcourseradar(Request $request)
    {
        ...
        if ($queryyear)
            ...
            else
            {
              ...
              return view('testing.radar.radarcoursecombined')
    ...
    public function combinedyearradar(Request $request)
    {
        $querycourse = $request->course;
        ...
        if ($querycourse)
            ...
            else
            {
              ...
              $year = array_pluck($year, 'year_count');
                ...
                return view('testing.radar.radaryearcombined')
