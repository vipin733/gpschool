...
class AnalysisBarController extends Controller
{
    ...
    public function yearbar(Request $request)
    {
            ...
            else
            {
              ...
              $year = Cache::remember('year', 5, function()
              {
               ...
               $year = array_pluck($year, 'year_count');
               	...
               	return view('testing.bar.baryear')
    	       ->with('student',json_encode($student,JSON_NUMERIC_CHECK))
              ->with('year',json_encode($year,JSON_NUMERIC_CHECK));

    }

    public function coursesbar(Request $request)
    {
    	$query = $request->year;
        ...
        if ($queryyear)
            ...
            else
            {
              ...
              $course_name = array_column($course_name, 'course');
               ...
               return view('testing.bar.barcoursecombined')
    ...
    public function combinedyearbar(Request $request)
    {
        $querycourse = $request->course;
        ...
        if ($querycourse)
            ...
            else
            {
              ...
              $year = Cache::remember('year', 5, function()
              {
                ...
                return view('testing.bar.baryearcombined')
